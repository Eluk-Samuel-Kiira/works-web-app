...
!function() {
    ...
    function at(t) {
        const e = t + "Storage";
        try {
            if (ct && ct[e] && "number" == typeof ct[e].length)
                return ct[e]
        } catch (t) {}
        it[t] = !1
    }
    ...
    function Tt(t, e) {
        ...
        t.appendChild(n)),
        n.textContent = ":host{display:inline-block;vertical-align:" + (e ? "-0.125em" : "0") + "}span,svg{display:block}" + Et
    }
    function Ft(t, e) {
