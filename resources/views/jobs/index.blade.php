...
<head>
  ...
  <!-- Favicon icon-->
  <link rel="shortcut icon" type="image/png" href="{{ web_asset('front/images/logos/favicon.png') }}" />
...
<body>
      ...
      <div class="container-fluid d-flex justify-content-between">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mx-auto mb-2 gap-xl-7 gap-8 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active fs-4 text-dark link-primary px-6" href="../main/frontend-blogpage.html">Blog</a>
            </li>
  ...
  <div class="main-wrapper overflow-hidden">
    ...
    <!-- List Start -->
    <!-- ------------------------------------- -->
    <section class="py-3 py-md-7 py-lg-12">
      <div class="container-fluid">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 order-first order-lg-last">
              <div class="blog-bg d-flex flex-column justify-content-between p-9 h-100 flex-grow-1">
                <img src="{{ web_asset('front/images/profile/user-6.jpg') }}" alt="user" width="44" height="44" class="rounded-circle">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-3 overflow-hidden">
              <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                <img src="{{ web_asset('front/images/frontend-pages/blog-1.jpg') }}" alt="blog image" class="w-100 img-fluid">
                ...
                <div class="position-absolute bottom-0 ms-7 mb-n9">
                  <img src="{{ web_asset('front/images/profile/user-3.jpg') }}" alt="user" class="rounded-circle" width="44px" height="44px">
                </div>
              </a>
              <div class="mt-7 px-7 pb-7 h-100">
                <div class="d-flex gap-3 flex-column h-100 justify-content-between">
                  ...
                  <a href="../main/frontend-blogdetailpage.html" class="fs-5 fw-semibold">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex gap-9">
                      <div class="d-flex gap-2">
                        <i class="ti ti-eye fs-5 text-dark"></i>
                        <p class="mb-0 fs-2">6941</p>
                      </div>
                      <div class="d-flex gap-2">
                        <i class="ti ti-message fs-5 text-dark"></i>
                        <p class="mb-0 fs-2">3</p>
                      </div>
                    </div>
                    <div class="d-flex align-items-center gap-2">
                      <i class="ti ti-circle fs-2"></i>
                      <p class="mb-0 fs-2">Tue, May 2</p>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-3 overflow-hidden">
              <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                <img src="{{ web_asset('front/images/frontend-pages/blog-2.jpg') }}" alt="blog image" class="w-100 img-fluid">
                <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                  <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                </div>
                <div class="position-absolute bottom-0 ms-7 mb-n9">
                  <img src="{{ web_asset('front/images/profile/user-1.jpg') }}" alt="user" class="rounded-circle" width="44px" height="44px">
                </div>
              </a>
              <div class="mt-7 px-7 pb-7 h-100">
                <div class="d-flex gap-3 flex-column h-100 justify-content-between">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-3 overflow-hidden">
              <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                <img src="{{ web_asset('front/images/frontend-pages/blog-3.jpg') }}" alt="blog image" class="w-100 img-fluid">
                <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                  <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                </div>
                <div class="position-absolute bottom-0 ms-7 mb-n9">
                  <img src="{{ web_asset('front/images/profile/user-5.jpg') }}" alt="user" class="rounded-circle" width="44px" height="44px">
                </div>
              </a>
              <div class="mt-7 px-7 pb-7 h-100">
                <div class="d-flex gap-3 flex-column h-100 justify-content-between">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-3 overflow-hidden">
              <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                <img src="{{ web_asset('front/images/frontend-pages/blog-4.jpg') }}" alt="blog image" class="w-100 img-fluid">
                <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                  <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                </div>
                <div class="position-absolute bottom-0 ms-7 mb-n9">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-3 overflow-hidden">
              <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                <img src="{{ web_asset('front/images/frontend-pages/blog-5.jpg') }}" alt="blog image" class="w-100 img-fluid">
                <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                  <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                </div>
                <div class="position-absolute bottom-0 ms-7 mb-n9">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-3 overflow-hidden">
              <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                <img src="{{ web_asset('front/images/frontend-pages/blog-6.jpg') }}" alt="blog image" class="w-100 img-fluid">
                <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                  <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                </div>
                <div class="position-absolute bottom-0 ms-7 mb-n9">
                  <img src="{{ web_asset('front/images/profile/user-2.jpg') }}" alt="user" class="rounded-circle" width="44px" height="44px">
                </div>
              </a>
              <div class="mt-7 px-7 pb-7 h-100">
                <div class="d-flex gap-3 flex-column h-100 justify-content-between">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-3 overflow-hidden">
              <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                <img src="{{ web_asset('front/images/frontend-pages/blog-7.jpg') }}" alt="blog image" class="w-100 img-fluid">
                <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                  <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                </div>
                <div class="position-absolute bottom-0 ms-7 mb-n9">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-3 overflow-hidden">
              <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                <img src="{{ web_asset('front/images/frontend-pages/blog-8.jpg') }}" alt="blog image" class="w-100 img-fluid">
                <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                  <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                </div>
                <div class="position-absolute bottom-0 ms-7 mb-n9">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card rounded-3 overflow-hidden">
              <a href="../main/frontend-blogdetailpage.html" class="position-relative">
                <img src="{{ web_asset('front/images/frontend-pages/blog-9.jpg') }}" alt="blog image" class="w-100 img-fluid">
                <div class="position-absolute bottom-0 end-0 me-9 mb-3">
                  <p class="text-dark fs-2 px-2 rounded-pill bg-white mb-0 ">2 min Read</p>
                </div>
                <div class="position-absolute bottom-0 ms-7 mb-n9">
    ...
    <section class="bg-primary py-lg-11 py-5 position-relative">
      <div class="position-absolute top-50 start-0 translate-middle-y">
        <img src="{{ web_asset('front/images/frontend-pages/screenshot-1.png') }}" alt="image" class="d-xxl-block d-none">
      </div>
      <div class="container-fluid">
      ...
      <div class="position-absolute top-50 end-0 translate-middle-y">
        <img src="{{ web_asset('front/images/frontend-pages/screenshot-2.png') }}" alt="image" class="d-xxl-block d-none">
      </div>
    </section>
    <!-- ------------------------------------- -->
    <!-- Focus End -->
